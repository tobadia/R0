...
#' @param Tmax Maximum length of the epidemic (cases infected after this length
#' will be truncated).
#' @param n Number of epidemics to be simulated (default is 1)
#' @param family Distribution of offspring (default is "poisson").
#' @param negbin.size If \code{family} is set to "negbin", sets the size
#' parameter of the negative binomial distribution.
#' @return A matrix with epidemics stored as columns (incidence count)
#' @note This is not the final version. This is the exact function as used in
#' the manuscript (Obadia et al., 2012). It will be properly implemented to
#' conform with other objects of the package in future releases.
#' 
...
#' Crump-Mode-Jagers description, with S/E/I/R description of the natural
#' history. Latent and infectious period follow parametrized Gamma
#' distributions typical of influenza.  An index case is first introduced, and
#' offspring is sampled from a negative binomial distribution, with mean
